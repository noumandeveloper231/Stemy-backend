  ...
  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td align="center" style="border-radius:10px;background:linear-gradient(135deg,#1CE783,#4FE9A1);">
        <a href="${url}" target="_blank" style="display:inline-block;padding:14px 28px;font-family:'DM Sans','Inter Tight',-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;font-size:15px;font-weight:700;color:#052916;text-decoration:none;border-radius:10px;letter-spacing:0.02em;">Resubscribe</a>
      </td>
    </tr>
  </table>
